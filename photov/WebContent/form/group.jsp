	...
	<nested:iterate id="photoThumbs" name="photo" indexId="index">
		<logic:equal name="index" value="0">
			...
			<tr>
				...
				<th colspan="1">
					<bean:message key="th.group.groupid" />
				</th>
				<th colspan="1">
					<bean:message key="th.name" />
				</th>
				<th colspan="1">
					<bean:message key="th.desc" />
				</th>
			</tr>
		</logic:equal>
	<tr>
		<td colspan="1">
			<html:link href="group.do" paramId="groupId" paramName="photoThumbs" paramProperty="groupId">
				<bean:message key="edit" />
			</html:link>
		</td>
		<td colspan="1">
			<bean:write name="photoThumbs" property="groupId" /> &nbsp;
		</td>
		<td colspan="1">
			<bean:write name="photoThumbs" property="groupName" /><br>
		</td>
		<td colspan="1">
			<bean:write name="photoThumbs" property="groupDesc" /><br>
		</td>
	</tr>
	</nested:iterate>
	</table>
