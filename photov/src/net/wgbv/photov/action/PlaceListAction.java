 ...
 * 
 * XDoclet definition:
 * @struts:action path="/placeList" name="placeListForm" input="/form/placeList.jsp" validate="true"
 */
public class PlaceListAction extends Action {
	...
	public ActionForward execute(
		...
		PlaceListForm placeListForm = (PlaceListForm) form;
		String strForward = new String(Constants.PLACE_LIST_FORWARD);

		User user = null;
		if (request.getSession().getAttribute(Constants.USER_KEY) != null) {
			user = (User) request.getSession().getAttribute(Constants.USER_KEY);
		}
		OtherFactory.populatePlaceListForm(placeListForm);
